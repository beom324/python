...
#회귀모형의 앙상블 - 배깅
#의사결정나무 알고리즘의 회귀모델 여러개를 생성
from xgboost import XGBRegressor

#회귀모형의 앙상블 - 배깅
#의사결정나무 알고리즘의 회귀모델 여러개를 생성
#objective = 학습목표
#reg:squarederror = 오류의 제곱의 합을 줄이는 것이 목적이다.
model = XGBRegressor(max_depth=3,random_state=12,objective='reg:squarederror')
...
# 공부한 데이터의 오류 :  3.317555902833481
# 공부안한 데이터의 오류 :  22.66127833246217

# XGBRegressor는 데이터 양이 많을때에 높은 성능을 기대 할 수 있어요
# 위의 결과를 보면 학습한 데이터는 잘 맞추지만
# 새로운 데이터는 그것에 비해 예측력이 많이 떨어지는 것을 볼 수 있다.(과대적합)