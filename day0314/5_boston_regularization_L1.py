...
# 선형회귀모델에 L1규제를 적용한(LinearRegression + L1) Lasso를 생성해보자
# Lasso객체 생성시에 매개변수로 alpha값을 주는데 이는 규제 강도를 뜻한다.
...
# 학습한 데이터의 mse :  43.83335095383743
# 학습안한 데이터의 mse :  56.719511376687265
